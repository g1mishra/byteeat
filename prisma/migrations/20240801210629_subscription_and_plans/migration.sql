...
VALUES
  ('644acc43-34a5-4512-9618-67330fe39cf7', 'STARTER', 'Starter Plan', 'This is the Starter Plan with digital menu only.', 2999, 'year', 'INR', false, '["DIGITAL_MENU"]');

-- Add pro plan
INSERT INTO "Plan" (id, type, name, description, price, interval, currency, "isDefault", features)
VALUES
  ('06e9fea5-422b-45be-aaee-0ff87434ff9a', 'PRO', 'Pro Plan', 'This is the Pro Plan with all features.', 4999, 'year', 'INR', false, '["DIGITAL_MENU", "ORDERING", "RESERVE_TABLE"]');
