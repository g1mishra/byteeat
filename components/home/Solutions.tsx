      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-8 md:grid-cols-3">
          {solutions.map((solution, index) => (
            <div
              key={index}
              className={`${styles.cardGradient} rounded-2xl p-8 transition-shadow hover:shadow-xl`}
            >
              <div className={`${styles.iconGradient} mb-6 inline-block`}>{solution.icon}</div>
