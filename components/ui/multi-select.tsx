...
interface MultiSelectProps
   ...
   */
  onValueChange?: (value: string[]) => void // Make this prop optional

  /** The default selected values when the component mounts. */
  defaultValue?: string[]

  /**
   * The selected values to be displayed in the multi-select component.
   * This prop overrides the default values.
   */
  value?: string[]
...
export const MultiSelect = React.forwardRef<HTMLButtonElement, MultiSelectProps>(
  (
    ...
    // Add a default function if onValueChange is not provided
    const handleValueChange = React.useCallback(
      (value: string[]) => {
        if (typeof onValueChange === "function") {
          onValueChange(value)
        } else {
          console.warn("onValueChange prop is not a function or not provided")
        }
      },
      [onValueChange]
    )
