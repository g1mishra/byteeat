...
function Actions(rowOrder: any) {
    ...
    try {
        const updatedOrder = await updateOrderStatus(rowOrder.rowOrder.id, newStatus);
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end">
            ...
            {statuses.map((curr) => 
                ...
                ((curr != rowOrder.rowOrder.status)?<DropdownMenuItem key={curr} onClick={() => {
                    console.log("onclick")
                    handleStatusChange(curr)
                }}>{curr}</DropdownMenuItem>:null)
            )}
            <DropdownMenuSeparator />
            <Link href={`/manage/restaurant/${rowOrder.rowOrder.restaurantId}/orders/${rowOrder.rowOrder.id}`}>
            <DropdownMenuItem>
                Open order
            </DropdownMenuItem>
            </Link>
